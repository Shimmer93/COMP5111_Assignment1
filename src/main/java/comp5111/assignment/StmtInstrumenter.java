...
public class StmtInstrumenter extends BodyTransformer{
    ...
    protected void internalTransform(Body body, String phase, Map options){
        ...
        while (stmtIt.hasNext()) {
            ...
            StmtCounter.addStmt(className, stmt.toString());
            
            InvokeExpr incExpr = null;
            incExpr = Jimple.v().newStaticInvokeExpr(addInvocationMethod.makeRef(), StringConstant.v(className), StringConstant.v(stmt.toString()));
