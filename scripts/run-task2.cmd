...
FOR %%C IN (Subject_evosuite33_ESTest, Subject_evosuite66_ESTest, Subject_evosuite67_ESTest, Subject_randoop10_RegressionTest0, Subject_randoop990021_RegressionTest0, Subject_randoop990044_RegressionTest0) DO (
    ...
    javac -classpath ".;%CLASSPATH%;%ROOT_DIR%\lib\*;%ROOT_DIR%\raw-classes;%ROOT_DIR%\target\classes" -d "%ROOT_DIR%\target\test-classes"^
        "%ROOT_DIR%\src\test\fault-revealing-evosuite0\comp5111\assignment\cut\*.java"^
        "%ROOT_DIR%\src\test\fault-revealing-evosuite1\comp5111\assignment\cut\*.java"^
        "%ROOT_DIR%\src\test\fault-revealing-evosuite2\comp5111\assignment\cut\*.java"^
        "%ROOT_DIR%\src\test\fault-revealing-randoop0\comp5111\assignment\cut\*.java"^
        "%ROOT_DIR%\src\test\fault-revealing-randoop1\comp5111\assignment\cut\*.java"^
        "%ROOT_DIR%\src\test\fault-revealing-randoop2\comp5111\assignment\cut\*.java"
