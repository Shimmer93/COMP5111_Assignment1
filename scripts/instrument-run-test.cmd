...
java -classpath ".;%CLASSPATH%;%ROOT_DIR%\lib\*;%ROOT_DIR%\target\classes;%ROOT_DIR%\target\test-classes" comp5111.assignment.Assignment1 0 comp5111.assignment.cut.Regression_0_Test -process-dir "%ROOT_DIR%\raw-classes"